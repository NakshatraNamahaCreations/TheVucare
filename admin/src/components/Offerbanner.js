...
function Banner() {
  ...
  const getbannerimg = async () => {
    let res = await axios.get(
      "http://api.thevucare.com/api/userapp/getallofferbanner"
    );
    if ((res.status = 200)) {
  ...
  const deletebannerimg = async (id) => {
    axios({
      method: "post",
      url: "http://api.thevucare.com/api/userapp/deleteofferbanner/" + id,
    })
                        ...
                        <tr key={i}>
                          ...
                          <td>
                            <img
                             ...
                             src={`http://api.thevucare.com/offerbanner/${element.icon}`}
                              width={"50px"}
                              height={"50px"}
                            />
                          </td>
