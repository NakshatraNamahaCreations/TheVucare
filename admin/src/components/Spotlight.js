...
function Spotlight() {
  ...
  const getbannerimg = async () => {
    let res = await axios.get(
      "http://api.thevucare.com/api/userapp/getallspotlightbanner"
    );
    if ((res.status = 200)) {
  ...
  const deletebannerimg = async (id) => {
    axios({
      method: "post",
      url: "http://api.thevucare.com/api/userapp/deletespotlightbanner/" + id,
    })
                      ...
                      return (
                        <tr key={i}>
                          ...
                          <td>
                            ...
                            src={`http://api.thevucare.com/spotlight/${element.banner}`}
                              width={"100px"}
                              height={"50px"}
                            />
                          </td>
