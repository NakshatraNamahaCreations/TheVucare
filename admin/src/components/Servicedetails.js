...
const [postsubdata, setpostsubdata] = useState([]);
  ...
  const getslots = async () => {
    let res = await axios.get("http://api.thevucare.com/api  /userapp/getslots");
    if ((res.status = 200)) {
  ...
  const gettitle = async () => {
    let res = await axios.get("http://api.thevucare.com/api  /userapp/gettitle");
    if ((res.status = 200)) {
  ...
  const handleDeleteClick = async (slotid) => {
    ...
    try {
      const response = await axios.delete(
        `http://api.thevucare.com/api  /userapp/deleteStoreSlot/${sid}/${slotid}`
      );
  ...
  const handleDeleteprice = async (id, index) => {
    try {
      const response = await axios.delete(
        `http://api.thevucare.com/api  /userapp/deleteprice/${sid}/${id}`
      );
            ...
            <div className="col-md-3">
              ...
              >
                ...
                {ServiceImg1 ? (
                  ...
                  <img
                   src={`http://api.thevucare.com/service/${Servicedata[0]?.serviceImg}`}
                  />
                )}
                    ...
                    <Row className="mb-2">
                      <Form.Group as={Col} controlId="formGridEmail">
                        ...
                        <img
                         ...
                         src={`http://api.thevucare.com/service/${Servicedata[0]?.Desimg}`}
                        />
                      ...
                      <Form.Group as={Col} controlId="formGridEmail">
                        ...
                        <img
                          style={{ width: "15px", height: "15px" }}
                         src={`http://api.thevucare.com/service/${Servicedata[0]?.Inimg}`}
                        />
