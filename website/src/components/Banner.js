...
function Banner() {
  ...
  const getbannerimg = async () => {
    let res = await axios.get("http://api.thevucare.com/api/userapp/getallbanner");
    if ((res.status = 200)) {
  ...
  const deletebannerimg = async (id) => {
    axios({
      method: "post",
      url: "http://api.thevucare.com/api/userapp/deletebanner/" + id,
    })
                      ...
                      return (
                        <tr key={i}>
                          ...
                          <td>
                            ...
                            src={`http://api.thevucare.com/userbanner/${element.banner}`}
                              width={"100px"}
                              height={"50px"}
                            />
                          </td>
