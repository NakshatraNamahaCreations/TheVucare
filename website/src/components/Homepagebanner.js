...
function Homepagebanner() {
  ...
  const getbannerimg = async () => {
    let res = await axios.get("http://api.thevucare.com/api/userapp/getallhomebanner");
    if ((res.status = 200)) {
  ...
  const deletebannerimg = async (id) => {
    axios({
      method: "post",
      url: "http://api.thevucare.com/api/userapp/deletehomebanner/" + id,
    })
                      ...
                      return (
                        <tr key={i}>
                          ...
                          <td>
                            ...
                            src={`http://api.thevucare.com/homepagebanner/${element.banner}`}
                              width={"100px"}
                              height={"50px"}
                            />
                          </td>
